...
结果：`.venv/bin/pytest tests/test_packaging_assets.py tests/test_installers.py tests/test_self_check.py tests/test_resources.py`：17 passed。git diff --check通过；发布配置中未残留0.30.15。代码与标签待推送。
