...
根据 `custId` 获取 `qulificationAuditUrl` 并进入真实资质提交页面。旧版点击“资质环节”；新版流程由任务 21 补充，在“资质信息审核”卡片内点击“查看”并切换到新页面。
...
> 新版补充：接口链接可能二次跳转到 `/newaudit#/lice/...` 管理中心。此时点击“资质信息审核”卡片内的“查看”，捕获新打开的 `/newaudit#/lice/submit/...` 页面，并等待“URL状态概览”。详见任务 21。
...
- 能识别新版动态 `/newaudit#/lice/submit/...` 页面并切换到新标签页。
